...
module.exports = {
  ...
  BOT_NAME: getConfig("BOT_NAME") || process.env.BOT_NAME || "Cyberia-MD", // Bot's display name
  MODE: getConfig("MODE") || process.env.MODE || "private", // Bot mode: public/private/group/inbox
  REPO: process.env.REPO || "https://github.com/NaCkS-ai/Cyberia-MD", // Bot's GitHub repo
  ...
  OWNER_NUMBER: settings.OWNER_NUMBER || process.env.OWNER_NUMBER || "27649342626", // Owner's WhatsApp number
  OWNER_NAME: getConfig("OWNER_NAME") || process.env.OWNER_NAME || "Dev Sung", // Owner's name
  DEV: process.env.DEV || "27649342626", // Developer's contact
  DEVELOPER_NUMBER: '27649342626@s.whatsapp.net', // Developer's WhatsApp ID
  ...
  MENU_IMAGE_URL: getConfig("MENU_IMAGE_URL") || process.env.MENU_IMAGE_URL || "https://files.catbox.moe/lvomei.jpg", // Menu image
  ...
  DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ cyberia*", // Bot footer
  ...
  version: process.env.version || "2.5.0", // Bot version
  TIMEZONE: settings.TIMEZONE || process.env.TIMEZONE || "Africa/Harare", // Bot timezone


  // ===== CATEGORY-SPECIFIC IMAGE URLs =====
  MENU_IMAGES: {
    '1': process.env.DOWNLOAD_MENU_IMAGE || "https://files.catbox.moe/lvomei.jpg", // Download Menu
    '2': process.env.GROUP_MENU_IMAGE || "https://files.catbox.moe/lvomei.jpg",   // Group Menu
    '3': process.env.FUN_MENU_IMAGE || "https://files.catbox.moe/lvomei.jpg",  // Fun Menu
    '4': process.env.OWNER_MENU_IMAGE || "https://files.catbox.moe/lvomei.jpg",   // Owner Menu
    '5': process.env.AI_MENU_IMAGE || "https://files.catbox.moe/lvomei.jpg",         // AI Menu
    '6': process.env.ANIME_MENU_IMAGE || "https://files.catbox.moe/lvomei.jpg",   // Anime Menu
    '7': process.env.CONVERT_MENU_IMAGE || "https://files.catbox.moe/lvomei.jpg", // Convert Menu
    '8': process.env.OTHER_MENU_IMAGE || "https://files.catbox.moe/lvomei.jpg",   // Other Menu
    '9': process.env.REACTION_MENU_IMAGE || "https://files.catbox.moe/lvomei.jpg", // Reaction Menu
    '10': process.env.MAIN_MENU_IMAGE || "https://files.catbox.moe/lvomei.jpg",    // Main Menu
    '11': process.env.LOGO_MAKER_MENU_IMAGE || "https://files.catbox.moe/lvomei.jpg", // Logo Maker Menu
    '12': process.env.SETTINGS_MENU_IMAGE || "https://files.catbox.moe/lvomei.jpg", // Settings Menu
    '13': process.env.AUDIO_MENU_IMAGE || "https://files.catbox.moe/lvomei.jpg",  // Audio Menu
    '14': process.env.PRIVACY_MENU_IMAGE || "https://files.catbox.moe/lvomei.jpg" // Privacy Menu
  }
};
