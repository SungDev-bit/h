...
module.exports = {
  ...
  ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/lvomei.jpg",
// add img for alive msg

  LIVE_MSG: process.env.LIVE_MSG || "> ʙᴏᴛ ɪs sᴘᴀʀᴋɪɴɢ ᴀᴄᴛɪᴠᴇ ᴀɴᴅ ᴀʟɪᴠᴇ\n\n\nᴋᴇᴇᴘ ᴜsɪɴɢ 🔱Cyberia-MD🔱 ғʀᴏᴍ sung ᴛᴇᴄʜ ɪɴᴄ⚡\n\n\n*© ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ - ᴍᴅ\n\n> ɢɪᴛʜᴜʙ :* https://github.com/NaCkS-ai/Drakonis-MD",
// add alive msg here 
  ...
  MENU_IMAGE_URL: getConfig("MENU_IMAGE_URL") || "https://files.catbox.moe/lvomei.jpg", // Menu image URL
  ...
  DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Cyberia*", // Bot description/footer
