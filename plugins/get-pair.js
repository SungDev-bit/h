...
malvin({
    ...
    react: '✅',
    desc: 'Get pairing code for Cyberia-MD bot',
    category: 'download',
    ...
    try {
        ...
        // Make API request
        const response = await axios.get(`https://cyberia-universe1.onrender.com/code?number=${encodeURIComponent(phoneNumber)}`);
